...
void DocumentHandler::setDocument(QQuickTextDocument *document)
{
    ...
    m_document = document;
    m_document->textDocument()->setUndoRedoEnabled(false); // TODO: var
...
void DocumentHandler::setBold(bool bold)
{
    ...
    mergeFormatOnWordOrSelection(format);
    // setTextColor(bold ? QColor("#fa4868") : QColor("black"));
    emit boldChanged();
}
...
bool DocumentHandler::overline() const
{
    QTextCursor cursor = textCursor();
    if (cursor.isNull())
        return false;
    return textCursor().charFormat().fontOverline();
}

void DocumentHandler::setOverline(bool overline)
{
    QTextCharFormat format;
